...
import com.example.basketball.controller.activities.master_detail.PlayerCreationActivity;
...
public class PlayerManager {
    ...
    public synchronized void createPlayer(Player player, final PlayerCreationCallback playerCallback){
        ...
        call.enqueue(new Callback<Player>() {
            ...
            public void onFailure(Call<Player> call, Throwable t) {
                Log.e("PlayerManager->", "createPlayer()->ERROR: " + t);
