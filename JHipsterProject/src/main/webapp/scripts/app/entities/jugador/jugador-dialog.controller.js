...
angular.module('ligaBaloncestoApp').controller('JugadorDialogController',
    ['$scope', '$stateParams', '$modalInstance', 'entity', 'Jugador', 'JugadorJuegaPartido', 'Equipo',
        function($scope, $stateParams, $modalInstance, entity, Jugador, JugadorJuegaPartido, Equipo) {
