...
angular.module('ligaBaloncestoApp').controller('EquipoDialogController',
    ['$scope', '$stateParams', '$modalInstance', '$q', 'entity', 'Equipo', 'Estadio', 'Jugador', 'Entrenador', 'Socio', 'Temporada', 'Partido',
        function($scope, $stateParams, $modalInstance, $q, entity, Equipo, Estadio, Jugador, Entrenador, Socio, Temporada, Partido) {
